...
IGNORED_SKILLS = {
    ...
    'english', 'mandarin', 'bahasa', 'japanese', 'korean', 'french', 'german',
    'spanish', 'chinese',
    
    # Certifications (to ignore)
    'certified', 'certification', 'certificate', 'diploma', 'degree', 'bachelor',
    'master', 'phd', 'ccna', 'cisco', 'comptia',
    
    # Vague/process terms
    'skills', 'technical', 'summary', 'education', 'experience', 'certifications',
    'additional', 'core', 'programme', 'description', 'methodologies', 
    'principles', 'strategies', 'protocols', 'life cycle', 'best practices',
    'cooking', 'code reviews', 'data processing', 'labeling', 'testing',
}
