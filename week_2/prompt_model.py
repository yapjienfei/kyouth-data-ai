...
class RateLimiter:
    ...
    def __init__(self, rate_limits_file="rate_limits.txt", storage_file="rate_usage.json"):
    ...
    def _clean_old_records(self, model):
        ...
        self.usage[model]["tokens"] = [(t, count) for t, count in self.usage[model]["tokens"] if t > minute_ago]
